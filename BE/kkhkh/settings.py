"""
Django settings for khkh project.
...
SECRET_KEY = 'django-insecure-hc*=s3fh0hwpbz3c@0t1)y2koaf@i718c8c_0=#2*f&r$d=*n3'
...
WSGI_APPLICATION = 'kkhkh.wsgi.application'
